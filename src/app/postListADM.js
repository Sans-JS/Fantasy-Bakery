...
import { eliminar_boda, editar_boda, ActualizarBoda } from "./firebase.js";
import { showMessage } from "./showMessage.js";

// Selecciona el elemento HTML con la clase 'posts_boda' y el formulario con id 'producto-form'
...
// Función que configura la visualización de las publicaciones de boda
export const setUpPost = (data) => {
    if (data.length) {
        ...
        postList_boda.innerHTML = html; // Establece el contenido HTML del elemento 'postList_boda' con el HTML generado
        ...
        btnDelete.forEach(btn => {
            btn.addEventListener('click', async ({ target: { dataset } }) => {
                try {
                    // Llama a la función 'eliminar_boda' con el ID del elemento seleccionado
            ...
            btn.addEventListener('click', async (e) => {
                ...
                productoForm.addEventListener('submit', async (e) => {
                    ...
                    try {
                        ...
                        // Actualiza la publicación utilizando la función 'ActualizarBoda'
